...
OBJS	= $(S_PATH)/main.o $(S_PATH)/gsm_io.o \
	...
	$(S_PATH)/kfunctions.o $(S_PATH)/global.o\
	$(S_PATH)/qfunctions.o $(S_PATH)/clpt.o $(S_PATH)/rsd.o \
...
INCL	= $(S_PATH)/globaldefs.h $(S_PATH)/cmdline_defs.h \
    $(S_PATH)/protodefs.h $(S_PATH)/models.h $(S_PATH)/clpt.h $(S_PATH)/rsd.h \
    $(H_PATH)/diffeqs.h $(S_PATH)/qfunctions.h  \
